...
void handleReset(void)
{
  ...
  package.DestinationID = 0x1; // cdh destination

  package.command = 0x01; // ACK command code 
  package.data[0] = 0xC0; // Response command code 
